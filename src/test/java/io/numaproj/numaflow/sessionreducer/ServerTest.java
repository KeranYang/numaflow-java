...
public class ServerTest {
    ...
    public void open_merge_close() {
        System.out.println("kerantest - unit test starts");
        // create an output stream observer
        ReduceOutputStreamObserver outputStreamObserver = new ReduceOutputStreamObserver();
        StreamObserver<Sessionreduce.SessionReduceRequest> inputStreamObserver = SessionReduceGrpc
                .newStub(inProcessChannel)
    ...
    public void open_merge_append_close() {
        ...
        assertEquals(
                Sessionreduce.SessionReduceResponse.newBuilder()
                        ...
                        .setResult(Sessionreduce.SessionReduceResponse.Result.newBuilder()
                                .addAllKeys(List.of("client2" + REDUCE_PROCESSED_KEY_SUFFIX))
                                .setValue(ByteString.copyFromUtf8(String.valueOf(50))))
                        .build(),
                result.get(1));
        assertEquals(
                Sessionreduce.SessionReduceResponse.newBuilder()
        ...
        List<Sessionreduce.SessionReduceRequest> requests = List.of(
                ...
                Sessionreduce.SessionReduceRequest
                        ...
                        .setOperation(Sessionreduce.SessionReduceRequest.WindowOperation
                                ...
                                .build())
                        .build(),
                // expand the window for key client1, value 10. expand [60000, 85000] to [60000, 95000]
                Sessionreduce.SessionReduceRequest
                        .newBuilder()
                        .setOperation(Sessionreduce.SessionReduceRequest.WindowOperation
                                .newBuilder()
                        ...
                        .setPayload(Sessionreduce.SessionReduceRequest.Payload.newBuilder()
                                ...
                                .build())
                        .build(),
                // expand the window for key client2, value 10. expand [60000, 88000] to [60000, 98000]
                Sessionreduce.SessionReduceRequest
                        .newBuilder()
                        .setOperation(Sessionreduce.SessionReduceRequest.WindowOperation
                                .newBuilder()
    ...
    public void open_merge_merge_close() {
        ...
        List<Sessionreduce.SessionReduceRequest> requests = List.of(
                ...
                Sessionreduce.SessionReduceRequest
                        ...
                        .setOperation(Sessionreduce.SessionReduceRequest.WindowOperation
                                ...
                                .build())
                        .build(),
                // open a window for key client1, value 10. window start 50000, end 80000
                Sessionreduce.SessionReduceRequest
                        .newBuilder()
                        .setOperation(Sessionreduce.SessionReduceRequest.WindowOperation
                                .newBuilder()
                                ...
                                .addAllKeyedWindows(List.of(Sessionreduce.KeyedWindow.newBuilder()
                                        .addAllKeys(List.of("client1"))
                                        .setStart(Timestamp
                                                .newBuilder().setSeconds(50000).build())
                                        .setEnd(Timestamp.newBuilder().setSeconds(80000).build())
                                        .setSlot("slot-0").build()))
                                .build())
                        .setPayload(Sessionreduce.SessionReduceRequest.Payload.newBuilder()
                                .addAllKeys(List.of("client1"))
                                ...
                                .build())
                        .build(),
                // open a window for key client2, value 10. window start 50000, end 80000
                Sessionreduce.SessionReduceRequest
                        .newBuilder()
                        .setOperation(Sessionreduce.SessionReduceRequest.WindowOperation
                                .newBuilder()
        ...
        assertEquals(
                Sessionreduce.SessionReduceResponse.newBuilder()
                        .setEOF(false)
                        .setKeyedWindow(Sessionreduce.KeyedWindow.newBuilder()
                                .setStart(Timestamp.newBuilder().setSeconds(50000).build())
                                .setEnd(Timestamp.newBuilder().setSeconds(85000).build())
                                .addAllKeys(List.of("client1"))
                                .setSlot("slot-0")
                                .build())
    ...
    @Test
    public void open_close_open_open_eof() {
        // create an output stream observer
        ReduceOutputStreamObserver outputStreamObserver = new ReduceOutputStreamObserver();
        StreamObserver<Sessionreduce.SessionReduceRequest> inputStreamObserver = SessionReduceGrpc
                .newStub(inProcessChannel)
        ...
        List<Sessionreduce.SessionReduceRequest> requests = List.of(
                ...
                Sessionreduce.SessionReduceRequest
                        ...
                        .setOperation(Sessionreduce.SessionReduceRequest.WindowOperation
                                ...
                                .build())
                        .build(),
                // open a window for key client2, value 20. window start 61000, end 69000
                Sessionreduce.SessionReduceRequest
                        .newBuilder()
                        .setOperation(Sessionreduce.SessionReduceRequest.WindowOperation
                                .newBuilder()
                        ...
                        .setPayload(Sessionreduce.SessionReduceRequest.Payload.newBuilder()
                                ...
                                .build())
                        .build(),
                // open a window for key client3, value 30. window start 62000, end 68000
                Sessionreduce.SessionReduceRequest
                        .newBuilder()
                        .setOperation(Sessionreduce.SessionReduceRequest.WindowOperation
                                .newBuilder()
                                .setEventValue(Sessionreduce.SessionReduceRequest.WindowOperation.Event.OPEN_VALUE)
                                .addAllKeyedWindows(List.of(Sessionreduce.KeyedWindow.newBuilder()
                                        .addAllKeys(List.of("client3"))
                                        .setStart(Timestamp
                                                .newBuilder().setSeconds(62000).build())
                                        .setEnd(Timestamp.newBuilder().setSeconds(68000).build())
                                        .setSlot("slot-0").build()))
                                .build())
                        .setPayload(Sessionreduce.SessionReduceRequest.Payload.newBuilder()
                                .addAllKeys(List.of("client3"))
        ...
        assertEquals(
                Sessionreduce.SessionReduceResponse.newBuilder()
                        .setEOF(false)
                        .setKeyedWindow(Sessionreduce.KeyedWindow.newBuilder()
                                .setStart(Timestamp.newBuilder().setSeconds(61000).build())
                                .setEnd(Timestamp.newBuilder().setSeconds(69000).build())
                                .addAllKeys(List.of("client2"))
                                .setSlot("slot-0")
                                .build())
        ...
        assertEquals(
                Sessionreduce.SessionReduceResponse.newBuilder()
                        .setEOF(false)
                        .setKeyedWindow(Sessionreduce.KeyedWindow.newBuilder()
                                .setStart(Timestamp.newBuilder().setSeconds(62000).build())
                                .setEnd(Timestamp.newBuilder().setSeconds(68000).build())
                                .addAllKeys(List.of("client3"))
                                .setSlot("slot-0")
                                .build())
                        .setResult(Sessionreduce.SessionReduceResponse.Result.newBuilder()
                                .addAllKeys(List.of("client3" + REDUCE_PROCESSED_KEY_SUFFIX))
                                .setValue(ByteString.copyFromUtf8(String.valueOf(30))))
                        .build(),
                result.get(2));
        assertEquals(
    ...
    @Test
    public void append_udf_send_to_output_close() {
        // create an output stream observer
        ReduceOutputStreamObserver outputStreamObserver = new ReduceOutputStreamObserver();
        StreamObserver<Sessionreduce.SessionReduceRequest> inputStreamObserver = SessionReduceGrpc
                .newStub(inProcessChannel)
        ...
        assertEquals(
                Sessionreduce.SessionReduceResponse.newBuilder()
                        ...
                        .setResult(Sessionreduce.SessionReduceResponse.Result.newBuilder()
                                .addAllKeys(List.of("client1" + REDUCE_PROCESSED_KEY_SUFFIX))
                                .setValue(ByteString.copyFromUtf8(String.valueOf(60))))
                        .build(),
                result.get(1));
        assertEquals(
                Sessionreduce.SessionReduceResponse.newBuilder()
    ...
    public static class SessionReducerTestFactory extends SessionReducerFactory<SessionReducerTestFactory.TestSessionReducerHandler> {
        ...
        public static class TestSessionReducerHandler extends SessionReducer {
            ...
            public void mergeAccumulator(byte[] accumulator) {
                int value = Integer.parseInt(new String(accumulator));
                sum.addAndGet(value);
            }
        }
    }
